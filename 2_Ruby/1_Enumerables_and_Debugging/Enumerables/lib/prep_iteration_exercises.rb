...
def subwords(word, dictionary)
  ...
  substrings.each do |str|
    subwords << str if dict_set.include?(str)
  end

  subwords
end

# print substrings("cat")

# words = File.readlines("./dictionary.txt").map(&:chomp)
# print subwords("cat", words)
# print subwords("batcabtarbrat", words)
# print subwords("erbearsweatmyajs", words)
...
# print [1, 2, 3].my_map { |el| el * el } #=> [1, 4, 9]

# test_array = [1, 2, 3, 4, 5]
# print test_array.my_select(&:even?) #=>[1, 3, 5]

# print [1, 2, 3, 4].my_inject { |result, element| result + element }
...
def concatenate(strings)
  strings.my_inject { |sum, num| sum + num }
end

# strings = ["Yay ", "for ", "strings!"]
